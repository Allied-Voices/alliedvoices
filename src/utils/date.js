function calculateTimeSpan(referenceDate) {
  ...
  // 1 d = 86400000 ms
  else if (diff >= 7200000 && diff < 86400000) dateMsg = `${Math.floor(diff / 1000 / 60 / 60)} hours ago`;
  // 2 d = 172800000 ms
  else if (diff >= 86400000 && diff < 172800000) dateMsg = "1 day ago";
  // 11 d = 950400000 ms
  else if (diff >= 172800000 && diff < 950400000) dateMsg = `${Math.floor(diff / 1000 / 60 / 60 / 24)} days ago`;
